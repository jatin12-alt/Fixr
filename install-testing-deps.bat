...
call npm install -D jest @testing-library/react @testing-library/jest-dom @testing-library/user-event ts-jest

echo.
echo 📦 Installing additional testing utilities...
call npm install -D node-mocks-http @types/jest jest-environment-jsdom
