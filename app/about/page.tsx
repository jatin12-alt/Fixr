    ...
    <div className="min-h-screen bg-[#131317] selection:bg-primary selection:text-black">
      <div className="max-w-[1120px] mx-auto px-10 pt-[160px] pb-[120px] relative">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gradient-to-br from-[#1b1b1f] to-[#0e0e11] border border-white/5 text-white p-20 md:p-32 rounded-[40px] mb-40 relative overflow-hidden group shadow-3xl"
        >
        ...
        <div className="mb-[160px]">
          <h2 className="text-[11px] font-black uppercase tracking-[.5em] text-white/20 mb-20 text-center">Core Axioms</h2>
        ...
        {/* Leadership */}
        <div className="mb-[160px]">
          <h2 className="text-[11px] font-black uppercase tracking-[.5em] text-white/20 mb-20 text-center">Architect in Chief</h2>
          <div className="flex justify-center">
            <motion.div
               ...
               viewport={{ once: true }}
            >
              <Card className="max-w-[500px] w-full p-20 glass-card border-white/10 rounded-[40px] text-center relative overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.6)]">
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary/10 blur-[60px] rounded-full" />
                <div className="w-32 h-32 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mx-auto mb-10 relative z-10 p-2">
                  <div className="w-full h-full bg-black rounded-full flex items-center justify-center font-black text-3xl text-white shadow-glow">JD</div>
                </div>
                <h3 className="text-3xl font-black text-white mb-3 tracking-tighter">Jatin Dongre</h3>
                <p className="text-[12px] font-black text-primary/60 uppercase tracking-[0.4em] mb-10 text-glow">Founder & Principal Architect</p>
                <p className="text-[16px] text-white/40 mb-12 leading-relaxed font-medium italic px-4">
                ...
                <div className="flex justify-center gap-10">
                  <a href="https://github.com/jatin12-alt" className="text-white/20 hover:text-white transition-all transform hover:scale-125" target="_blank" rel="noopener">
                    <Github className="h-7 w-7" />
                  </a>
                  <a href="https://linkedin.com/in/jatin-dongre-6a13a3294" className="text-white/20 hover:text-primary transition-all transform hover:scale-125" target="_blank" rel="noopener">
