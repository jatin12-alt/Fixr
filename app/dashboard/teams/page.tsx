          ...
          <div className="animate-pulse">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 h-48"></div>
              ))}
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-black text-gray-300 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <button className="flex items-center space-x-2 px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg hover:border-cyan-500 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTeams.map((team) => (
              <motion.div
                ...
                className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-cyan-500/50 transition-all cursor-pointer"
              >
                <Link href={`/dashboard/teams/${team.id}`}>
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className={`px-2 py-1 text-xs font-medium text-white rounded-full ${getRoleColor(team.userRole)}`}>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-white">{team._count.members}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-400">Repositories</span>
                      <span className="text-white">{team._count.repositories}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
