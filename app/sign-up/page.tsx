    ...
    <div className="min-h-screen flex bg-[#0a0a0a] font-sans selection:bg-primary selection:text-black">
      ...
      <div className="hidden lg:flex w-[45%] bg-[#0e0e11] text-white p-16 flex-col justify-between relative overflow-hidden border-r border-white/5">
        <div className="relative z-10">
          ...
          <div className="mt-[16vh] max-w-[400px]">
            <span className="text-[11px] font-black tracking-[0.4em] text-primary/40 uppercase mb-8 block">Protocol Initialization</span>
            <h2 className="text-[64px] font-black mb-8 tracking-tighter leading-[0.85] text-white">
              Start <br /><span className="text-white/10 italic">Building.</span>
            </h2>
            <p className="text-[18px] text-white/40 mb-12 font-medium italic border-l border-primary/20 pl-8">
              "Join 2,000+ teams shipping faster with autonomous resolution and real-time telemetry."
            </p>
      ...
      <div className="w-full lg:w-[55%] flex items-center justify-center p-6 md:p-16 bg-[#0a0a0a] relative overflow-hidden">
        ...
        >
          ...
          <div className="mb-12">
            <h1 className="text-4xl font-black text-white mb-4 tracking-tighter leading-none">Create your <span className="text-white/10 italic">Account.</span></h1>
            <p className="text-sm text-white/30 font-medium">
              Already a member? <Link href="/sign-in" className="text-primary font-black uppercase tracking-widest text-[11px] hover:text-white transition-colors ml-2">Access Terminal</Link>
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                disabled={loading}
                className="h-14 flex items-center justify-center font-black uppercase tracking-[0.15em] text-[10px] border border-white/5 bg-white/5 hover:bg-primary hover:text-black transition-all rounded-xl shadow-2xl"
              >
